...
last_modified_at: 2023-05-23 13:29:00 +1200
---
...
[^fn2]: Not to mention, it is not possible to implement lenses (or other optics) in most languages as the concept requires Higher-Kinded Types (think "nested generics" e.g. `F<A>`), which very few languages support. It is only achievable in Java through am impressive yet hideous [hack](https://github.com/highj/highj).
